...
export function createBatchMetadataUpdateEvent(_fromTokenId: BigInt, _toTokenId: BigInt): BatchMetadataUpdate {
    ...
    batchMetadataUpdateEvent.parameters.push(new ethereum.EventParam("_fromTokenId", ethereum.Value.fromUnsignedBigInt(_fromTokenId)));
    batchMetadataUpdateEvent.parameters.push(new ethereum.EventParam("_toTokenId", ethereum.Value.fromUnsignedBigInt(_toTokenId)));
...
export function createCreateManagedEvent(
    ...
    createManagedEvent.parameters.push(new ethereum.EventParam("_mTokenId", ethereum.Value.fromUnsignedBigInt(_mTokenId)));
    createManagedEvent.parameters.push(new ethereum.EventParam("_from", ethereum.Value.fromAddress(_from)));
    createManagedEvent.parameters.push(new ethereum.EventParam("_lockedManagedReward", ethereum.Value.fromAddress(_lockedManagedReward)));
    createManagedEvent.parameters.push(new ethereum.EventParam("_freeManagedReward", ethereum.Value.fromAddress(_freeManagedReward)));

    return createManagedEvent;
}

export function createDelegateChangedEvent(delegator: Address, fromDelegate: BigInt, toDelegate: BigInt): DelegateChanged {
    ...
    delegateChangedEvent.parameters.push(new ethereum.EventParam("fromDelegate", ethereum.Value.fromUnsignedBigInt(fromDelegate)));
    delegateChangedEvent.parameters.push(new ethereum.EventParam("toDelegate", ethereum.Value.fromUnsignedBigInt(toDelegate)));

    return delegateChangedEvent;
}

export function createDelegateVotesChangedEvent(delegate: Address, previousBalance: BigInt, newBalance: BigInt): DelegateVotesChanged {
    let delegateVotesChangedEvent = changetype<DelegateVotesChanged>(newMockEvent());

    delegateVotesChangedEvent.parameters = new Array();

    delegateVotesChangedEvent.parameters.push(new ethereum.EventParam("delegate", ethereum.Value.fromAddress(delegate)));
    delegateVotesChangedEvent.parameters.push(new ethereum.EventParam("previousBalance", ethereum.Value.fromUnsignedBigInt(previousBalance)));
    delegateVotesChangedEvent.parameters.push(new ethereum.EventParam("newBalance", ethereum.Value.fromUnsignedBigInt(newBalance)));

    return delegateVotesChangedEvent;
}

export function createDepositEvent(provider: Address, tokenId: BigInt, depositType: i32, value: BigInt, locktime: BigInt, ts: BigInt): Deposit {
    ...
    depositEvent.parameters.push(new ethereum.EventParam("depositType", ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(depositType))));
...
export function createDepositManagedEvent(_owner: Address, _tokenId: BigInt, _mTokenId: BigInt, _weight: BigInt, _ts: BigInt): DepositManaged {
    ...
    depositManagedEvent.parameters.push(new ethereum.EventParam("_tokenId", ethereum.Value.fromUnsignedBigInt(_tokenId)));
    depositManagedEvent.parameters.push(new ethereum.EventParam("_mTokenId", ethereum.Value.fromUnsignedBigInt(_mTokenId)));
...
export function createLockPermanentEvent(_owner: Address, _tokenId: BigInt, amount: BigInt, _ts: BigInt): LockPermanent {
    ...
    lockPermanentEvent.parameters.push(new ethereum.EventParam("_tokenId", ethereum.Value.fromUnsignedBigInt(_tokenId)));
...
export function createMergeEvent(
    ...
    mergeEvent.parameters.push(new ethereum.EventParam("_amountFinal", ethereum.Value.fromUnsignedBigInt(_amountFinal)));
...
export function createMetadataUpdateEvent(_tokenId: BigInt): MetadataUpdate {
    ...
    metadataUpdateEvent.parameters.push(new ethereum.EventParam("_tokenId", ethereum.Value.fromUnsignedBigInt(_tokenId)));
...
export function createSetAllowedManagerEvent(_allowedManager: Address): SetAllowedManager {
    ...
    setAllowedManagerEvent.parameters.push(new ethereum.EventParam("_allowedManager", ethereum.Value.fromAddress(_allowedManager)));
...
export function createSplitEvent(
    ...
    splitEvent.parameters.push(new ethereum.EventParam("_splitAmount1", ethereum.Value.fromUnsignedBigInt(_splitAmount1)));
    splitEvent.parameters.push(new ethereum.EventParam("_splitAmount2", ethereum.Value.fromUnsignedBigInt(_splitAmount2)));
...
export function createUnlockPermanentEvent(_owner: Address, _tokenId: BigInt, amount: BigInt, _ts: BigInt): UnlockPermanent {
    ...
    unlockPermanentEvent.parameters.push(new ethereum.EventParam("_tokenId", ethereum.Value.fromUnsignedBigInt(_tokenId)));
...
export function createWithdrawManagedEvent(_owner: Address, _tokenId: BigInt, _mTokenId: BigInt, _weight: BigInt, _ts: BigInt): WithdrawManaged {
    ...
    withdrawManagedEvent.parameters.push(new ethereum.EventParam("_tokenId", ethereum.Value.fromUnsignedBigInt(_tokenId)));
    withdrawManagedEvent.parameters.push(new ethereum.EventParam("_mTokenId", ethereum.Value.fromUnsignedBigInt(_mTokenId)));
    withdrawManagedEvent.parameters.push(new ethereum.EventParam("_weight", ethereum.Value.fromUnsignedBigInt(_weight)));
