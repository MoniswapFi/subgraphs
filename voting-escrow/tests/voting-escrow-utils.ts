...
export function createCreateManagedEvent(
  ...
  createManagedEvent.parameters.push(
    new ethereum.EventParam(
      "_mTokenId",
      ethereum.Value.fromUnsignedBigInt(_mTokenId)
    )
  )
  createManagedEvent.parameters.push(
  ...
  createManagedEvent.parameters.push(
    new ethereum.EventParam(
      ...
      ethereum.Value.fromAddress(_lockedManagedReward)
    )
  )
  createManagedEvent.parameters.push(
    new ethereum.EventParam(
      "_freeManagedReward",
      ethereum.Value.fromAddress(_freeManagedReward)
    )
  )
...
export function createDelegateChangedEvent(
  ...
  delegateChangedEvent.parameters.push(
    new ethereum.EventParam(
      "fromDelegate",
      ethereum.Value.fromUnsignedBigInt(fromDelegate)
    )
  )
  delegateChangedEvent.parameters.push(
    new ethereum.EventParam(
      "toDelegate",
      ethereum.Value.fromUnsignedBigInt(toDelegate)
    )
  )
...
export function createDepositEvent(
  ...
  depositEvent.parameters.push(
    new ethereum.EventParam(
      "depositType",
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(depositType))
    )
  )
  depositEvent.parameters.push(
...
export function createDepositManagedEvent(
  ...
  depositManagedEvent.parameters.push(
    new ethereum.EventParam("_ts", ethereum.Value.fromUnsignedBigInt(_ts))
  )
...
export function createMergeEvent(
  ...
  mergeEvent.parameters.push(
    new ethereum.EventParam(
      "_amountFrom",
      ethereum.Value.fromUnsignedBigInt(_amountFrom)
    )
  )
  mergeEvent.parameters.push(
    new ethereum.EventParam(
      "_amountTo",
      ethereum.Value.fromUnsignedBigInt(_amountTo)
    )
  )
  mergeEvent.parameters.push(
    new ethereum.EventParam(
      "_amountFinal",
      ethereum.Value.fromUnsignedBigInt(_amountFinal)
    )
  )
  mergeEvent.parameters.push(
    new ethereum.EventParam(
      "_locktime",
      ethereum.Value.fromUnsignedBigInt(_locktime)
    )
  )
  mergeEvent.parameters.push(
    new ethereum.EventParam("_ts", ethereum.Value.fromUnsignedBigInt(_ts))
...
export function createSetAllowedManagerEvent(
  _allowedManager: Address
): SetAllowedManager {
  ...
  setAllowedManagerEvent.parameters.push(
    new ethereum.EventParam(
      "_allowedManager",
      ethereum.Value.fromAddress(_allowedManager)
    )
  )
...
export function createSplitEvent(
  ...
  splitEvent.parameters.push(
    new ethereum.EventParam(
      "_tokenId1",
      ethereum.Value.fromUnsignedBigInt(_tokenId1)
    )
  )
  splitEvent.parameters.push(
    new ethereum.EventParam(
      "_tokenId2",
      ethereum.Value.fromUnsignedBigInt(_tokenId2)
    )
  )
  splitEvent.parameters.push(
    new ethereum.EventParam("_sender", ethereum.Value.fromAddress(_sender))
  ...
  splitEvent.parameters.push(
    new ethereum.EventParam(
      "_splitAmount1",
      ethereum.Value.fromUnsignedBigInt(_splitAmount1)
    )
  )
  splitEvent.parameters.push(
    new ethereum.EventParam(
      "_splitAmount2",
      ethereum.Value.fromUnsignedBigInt(_splitAmount2)
    )
  )
  splitEvent.parameters.push(
    new ethereum.EventParam(
