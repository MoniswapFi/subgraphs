...
import { handleAbstained } from "../mappings/voter";
...
describe("Describe entity assertions", () => {
    ...
    test("Abstained created and stored", () => {
        ...
        assert.fieldEquals("Abstained", "0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1", "voter", "0x0000000000000000000000000000000000000001");
        assert.fieldEquals("Abstained", "0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1", "pool", "0x0000000000000000000000000000000000000001");
