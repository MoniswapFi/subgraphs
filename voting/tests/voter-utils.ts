...
export function createGaugeCreatedEvent(
  ...
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam(
      "poolFactory",
      ethereum.Value.fromAddress(poolFactory)
    )
  )
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam(
      "votingRewardsFactory",
      ethereum.Value.fromAddress(votingRewardsFactory)
    )
  )
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam(
  ...
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam(
      "bribeVotingReward",
      ethereum.Value.fromAddress(bribeVotingReward)
    )
  )
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam(
      "feeVotingReward",
      ethereum.Value.fromAddress(feeVotingReward)
    )
  )
  gaugeCreatedEvent.parameters.push(
    new ethereum.EventParam("gauge", ethereum.Value.fromAddress(gauge))
...
export function createGaugeKilledEvent(gauge: Address): GaugeKilled {
  ...
  gaugeKilledEvent.parameters.push(
    new ethereum.EventParam("gauge", ethereum.Value.fromAddress(gauge))
  )
...
export function createGaugeRevivedEvent(gauge: Address): GaugeRevived {
  ...
  gaugeRevivedEvent.parameters.push(
    new ethereum.EventParam("gauge", ethereum.Value.fromAddress(gauge))
  )
...
export function createWhitelistNFTEvent(
  whitelister: Address,
  tokenId: BigInt,
  _bool: boolean
): WhitelistNFT {
  ...
  whitelistNftEvent.parameters.push(
    new ethereum.EventParam(
      "whitelister",
      ethereum.Value.fromAddress(whitelister)
    )
  )
  whitelistNftEvent.parameters.push(
    new ethereum.EventParam(
  ...
  whitelistNftEvent.parameters.push(
    new ethereum.EventParam("_bool", ethereum.Value.fromBoolean(_bool))
  )
